...
if(isset($_POST['preview']) || isset($_POST['facebook']))
	...
	if(odudecard_verify_comment_captcha()=="OK")
	{
		...
		<script>function odudecard_myFunction() {
  /* Get the text field */
...
<br>
	...
	{
		echo "<b>".odudecard_verify_comment_captcha()."</b><br><br><a href=\"javascript:history.go(-1)\" class=\"pure-button\">".__('Go Back', 'odude-ecard')."</a>";
	}
